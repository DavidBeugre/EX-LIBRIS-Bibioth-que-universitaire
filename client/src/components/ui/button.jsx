...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-ink text-paper hover:bg-ink/90 focus-visible:ring-ink",
        outline: "border border-border bg-transparent hover:bg-black/5 text-ink",
        ghost: "hover:bg-black/5 text-ink",
        moss: "bg-moss text-white hover:bg-moss/90 focus-visible:ring-moss",
        brass: "bg-brass text-white hover:bg-brass/90 focus-visible:ring-brass",
      },
      size: {
